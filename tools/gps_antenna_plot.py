...
# [O] 후보: 해치 뒤 500
for gx, col, tag in ((GX, "#2a9d2a", "[O] 해치 뒤 x=500"), (1190, "#d33", "[X] 해치 앞 x=1190")):
    a1.add_patch(Rectangle((gx - 75, DECK), 150, 4, fc="#777", ec="k"))
...
a1.text(GX, DECK - 60, "접지판 Ø150 (강판 or 알루미늄+나사)", ha="center", fontsize=8, color="#444")
...
# [O] GPS
a2.add_patch(Circle((GX, 0), 75, fc="#bbb", ec="k", alpha=0.6)); a2.add_patch(Rectangle((GX - 30, -41), 60, 82, fc="#eee", ec="#2a9d2a", lw=2))
a2.text(GX, 120, "[O] GPS 안테나 x=500 중심선\n접지판 Ø150 (앞끝 575 ↔ 해치 600)", ha="center", fontsize=9, color="#2a9d2a")
a2.annotate("", xy=(GX, -75), xytext=(GX, -W/2 + 20), arrowprops=dict(arrowstyle="-", color="#2a9d2a", ls=":"))
# [X] 후보들
