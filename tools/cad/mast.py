...
왜 이 형태인가:
  ...
  · 각도(D455 아래 12°, OAK 아래 7°)는 물 위 첫 시험에서 바꿀 수 있게 파라미터.

⚠️ 실측 필요:
  · OAK-1 **W** PoE 외형은 OAK-1 PoE(81.9×81.9×31, 뒷면 M4 45mm 간격) 와 같다고 가정 — 도착일 확인.
...
# OAK-1 (W) PoE: 81.9 × 81.9 × 31, 뒷면 M4 ×2 가로 45mm. ⚠️ W 모델 실측
