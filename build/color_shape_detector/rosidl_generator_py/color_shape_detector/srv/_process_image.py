...
class Metaclass_ProcessImage_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('color_shape_detector')
        except ImportError:
            import logging
            import traceback
...
class ProcessImage_Response(metaclass=Metaclass_ProcessImage_Response):
    ...
    def response(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'response' field must be an integer in [-2147483648, 2147483647]"
...
class Metaclass_ProcessImage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'color_shape_detector.srv.ProcessImage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from color_shape_detector.srv import _process_image
...
class ProcessImage(metaclass=Metaclass_ProcessImage):
    from color_shape_detector.srv._process_image import ProcessImage_Request as Request
    from color_shape_detector.srv._process_image import ProcessImage_Response as Response
