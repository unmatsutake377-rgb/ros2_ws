...
#ifndef COLOR_SHAPE_DETECTOR__SRV__DETAIL__PROCESS_IMAGE__FUNCTIONS_H_
#define COLOR_SHAPE_DETECTOR__SRV__DETAIL__PROCESS_IMAGE__FUNCTIONS_H_
...
#include "color_shape_detector/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_color_shape_detector
bool
 ...
 * calls
 * color_shape_detector__srv__ProcessImage_Request__init().
...
/**
 * It calls
 * color_shape_detector__srv__ProcessImage_Request__fini()
 ...
 * color_shape_detector__srv__ProcessImage_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * color_shape_detector__srv__ProcessImage_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * color_shape_detector__srv__ProcessImage_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_color_shape_detector
...
/**
 * It calls
 * color_shape_detector__srv__ProcessImage_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_color_shape_detector
...
/**
 * It allocates the memory for the array and calls
 * color_shape_detector__srv__ProcessImage_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_color_shape_detector
...
/**
 * It calls
 * color_shape_detector__srv__ProcessImage_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // COLOR_SHAPE_DETECTOR__SRV__DETAIL__PROCESS_IMAGE__FUNCTIONS_H_
